...
parser = arg.ArgumentParser(description='Calculate the dispersion index (index of crossing within each voxel) based on the sparse fascicle model')
...
if __name__ == "__main__":
    ...
    # Do it and save: 
    fvf = nib.Nifti1Image(Model.dispersion_index(),
