"""Utilities to facilitate the writing of tests for osmosis.
"""
#-----------------------------------------------------------------------------
# Imports
#-----------------------------------------------------------------------------
...
def test(doctests=True, verbose=True, coverage=True, first_package_wins=True,
         extra_argv=None):
    """

    Run the osmosis test suite using nose.
    ...
    argv = ['nosetests',
            # Name the package to actually test, in this case osmosis
            'osmosis',
    ...
    if coverage:
        ...
        argv.append('--cover-package=osmosis')
