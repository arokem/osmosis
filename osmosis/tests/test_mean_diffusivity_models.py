...
def test_optimize_MD_params():
    param_out, fit_out, ss_err = mdm.optimize_MD_params(data_pv, bvals_pv, bvecs_pv, mask_pv,
                                                        "decaying_exp", initial = -0.5,
                                                        bounds = [(None, None)], signal="log")
