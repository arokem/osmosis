...
def test_DWI():
    ...
    D1_w_affine = ozm.DWI(data_path + 'small_dwi.nii.gz',
            data_path + 'dwi.bvecs',
            data_path + 'dwi.bvals',
    ...
    D1_w_mask = ozm.DWI(data_path + 'small_dwi.nii.gz',
            data_path + 'dwi.bvecs',
            data_path + 'dwi.bvals',
    ...
    D1_subsampled = ozm.DWI(data_path + 'small_dwi.nii.gz',
                            data_path + 'dwi.bvecs',
                            data_path + 'dwi.bvals',
                            sub_sample=30)
    ...
    D2_sub_sampled = ozm.DWI(data, bvecs,bvals, sub_sample=np.array([0,1,2]))
...
def test_BaseModel():
    ...
    if has_numexpr:
        ozm.has_numexpr = False
        BM_wo_numexpr = ozm.BaseModel(data_path + 'small_dwi.nii.gz',
                       data_path + 'dwi.bvecs',
                       data_path + 'dwi.bvals')
...
def test_TensorModel():
    ...
    np.array([[[[ 0.72498638,  0.62960292,  0.43976463, -0.52642858,  0.28215774,
       ...
       [[ 0.60937325,  0.66467155,  0.69412507,  0.671757  ],
        ...
        npt.assert_almost_equal(TM.signal_adc[0][0],
